...
VALUES ('00000000-0000-0000-0000-000000000001', 'Cardiology'),
       ...
       ('00000000-0000-0000-0000-000000000006', 'Ophalmology');
...
VALUES ('00000000-0000-0000-0000-000000000001', 'Cardiology Department'),
       ...
       ('00000000-0000-0000-0000-000000000006', 'Ophalmology Department');
...
VALUES ('00000000-0000-0000-0000-000000000001', 'Main Street', '123', 'New York', 10001),
       ...
       ('00000000-0000-0000-0000-000000000005', 'Pine Road', '222', 'Miami', 33101);
          INSERT INTO "Address" ("Id", "StreetName", "StreetNumber", "City", "ZipCode")
VALUES ('00000000-0000-0000-0000-000000000006', 'Pine West', '55', 'Miami', 10203);
...
INSERT INTO "MedicalRecord" ("Id", "AppointmentDate", "PatientId", "Problem", "DoctorId")
VALUES
    ('00000000-0000-0000-0000-000000000001', '2023-05-31', '00000000-0000-0000-0000-000000000001',  'Problem 1', '00000000-0000-0000-0000-000000000003'),
    ('00000000-0000-0000-0000-000000000002', '2023-06-01', '00000000-0000-0000-0000-000000000002', 'Problem 2', '00000000-0000-0000-0000-000000000005')
